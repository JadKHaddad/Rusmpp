use crate::{
    ...
    values::{
        ...
        bearer_type::BearerType, broadcast_area_identifier::owned::BroadcastAreaIdentifier,
        ...
        message_payload::owned::MessagePayload, message_state::MessageState,
        ...
        privacy_indicator::PrivacyIndicator, set_dpf::SetDpf, sub_address::owned::Subaddress,
