    ...
    impl From<MessageDeliveryRequestTlvTag> for TlvTag {
        fn from(tag: MessageDeliveryRequestTlvTag) -> Self {
            match tag {
                ...
                MessageDeliveryRequestTlvTag::DestAddrNpInformation => {
...
mod value {
    ...
    use super::tag::MessageDeliveryRequestTlvTag;
...
mod tlv {
    ...
    use super::{tag::MessageDeliveryRequestTlvTag, value::MessageDeliveryRequestTlvValue};
    ...
    crate::create! {
        ...
        pub struct MessageDeliveryRequestTlv {
            ...
            value: Option<MessageDeliveryRequestTlvValue>,
        }
    }
    ...
    impl MessageDeliveryRequestTlv {
        ...
        pub const fn tag(&self) -> MessageDeliveryRequestTlvTag {
            self.tag
        }
        ...
        pub const fn value(&self) -> Option<&MessageDeliveryRequestTlvValue> {
            self.value.as_ref()
        }
    }
...
pub use tag::MessageDeliveryRequestTlvTag;
pub use tlv::MessageDeliveryRequestTlv;
pub use value::MessageDeliveryRequestTlvValue;
