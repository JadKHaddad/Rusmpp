...
impl<'a> BindTransmitter<'a> {
    ...
    pub fn builder() -> BindTransmitterBuilder<'a> {
        BindTransmitterBuilder::new()
    }
}

#[derive(Debug, Default)]
pub struct BindTransmitterBuilder<'a> {
    inner: BindTransmitter<'a>,
}

impl<'a> BindTransmitterBuilder<'a> {
    pub fn new() -> Self {
        Self::default()
    }
